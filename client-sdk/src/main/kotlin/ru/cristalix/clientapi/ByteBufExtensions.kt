...
fun ByteBuf.writeVarInt(value: Int): Unit =
    NetUtil.writeVarInt(value, this)

fun ByteBuf.readVarLong(): Long =
    NetUtil.readVarLong(this)
fun ByteBuf.writeVarLong(value: Long): Unit =
    NetUtil.writeVarLong(value, this)

fun ByteBuf.readId(): UUID =
    NetUtil.readId(this)
fun ByteBuf.writeId(id: UUID): Unit =
    NetUtil.writeId(id, this)

fun ByteBuf.readArray(limit: Int = readableBytes()): ByteArray =
...
fun ByteBuf.readBuffer(limit: Int): ByteBuf =
    NetUtil.readBuffer(this, limit)
fun ByteBuf.writeBuffer(buf: ByteBuf): Unit =
    NetUtil.writeBuffer(buf, this)
fun ByteBuf.writeBuffer(buf: ByteBuf, start: Int, end: Int): Unit =
    NetUtil.writeBuffer(buf, start, end, this)

fun ByteBuf.readUtf8(limit: Int = Int.MAX_VALUE): String =
    NetUtil.readUtf8(this, limit)
fun ByteBuf.writeUtf8(s: String): Unit =
    NetUtil.writeUtf8(s, this)

fun ByteBuf.readAscii(limit: Int = Int.MAX_VALUE): String =
    NetUtil.readAscii(this, limit)
fun ByteBuf.writeAscii(s: String): Unit =
    NetUtil.writeAscii(s, this)

fun ByteBuf.readGameProfile(nameLimit: Int = 16): GameProfile =
    NetUtil.readGameProfile(this, nameLimit)
fun ByteBuf.writeGameProfile(profile: GameProfile): Unit =
    NetUtil.writeGameProfile(profile, this)

fun ByteBuf.readDate(): Date =
    NetUtil.readDate(this)
fun ByteBuf.writeDate(date: Date): Unit =
    NetUtil.writeDate(date, this)

fun ByteBuf.readUtf8s(climit: Int, slimit: Int): List<String> =
    NetUtil.readUtf8s(this, climit, slimit)
fun ByteBuf.writeUtf8s(strings: List<String>): Unit =
